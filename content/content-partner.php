      ...
      <dl>
        ...
        <dd>
          ...
          <ul class="clearfix">
            ...
            <li><a href="<?php echo home_url(); ?>/partner/#cc">ALL</a></li><!--
            <?php
              $term = get_categories( array('taxonomy'=>'partner_category') );
              foreach( $term as $t ):
            ?>
          --><li><a href="<?php echo home_url(); ?>/partner/?c=<?php echo $t->slug; ?>&search_nonce=<?php echo wp_create_nonce('search_nonce'); ?>#cc"><?php echo $t->name; ?></a></li><!--
            <?php endforeach; ?>
-->
          </ul>
