...
<body class="<?php echo my_body_class(); ?>">
  ...
  <header id="header">
  	<div class="inner clearfix">
  		<h1><a href="<?php echo home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/h_logo.png" width="336" alt="いいネタ検索マッチングサイト THE・MATCH"></a></h1>
        ...
        <div class="wrap">
          <div id="social-icon-sp">
            ...
            <a href="
https://www.instagram.com/the.standard0/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/icon_insta.png" width="25" height="25" alt="" class="roll"></a>
          </div><!-- #social-icon -->
    			<nav id="gnav">
    				<ul>
              <li id="nav00"><a href="<?php echo home_url(); ?>/"><span>TOP</span></a></li>
              <li id="nav02"><a href="<?php echo home_url(); ?>/project/"><span>PROJECT</span></a></li>
              <li id="nav07"><a href="<?php echo home_url(); ?>/works"><span>WORKS</span></a></li>
              <li id="nav03"><a href="<?php echo home_url(); ?>/column/"><span>COLUMN</span></a></li>
              <li id="nav08"><a href="<?php echo home_url(); ?>#partner"><span>PARTNER</span></a></li>
              ...
              <li id="nav09"><a href="https://www.wantedly.com/companies/t-standard/projects" target="_blank"><span>RECRUIT</span></a></li>
...
<?php if( is_home() ): ?>
  <div id="mainvisual_new">
      ...
      <?php
  		  $args = array(
  				'post_type' => array('project_post','post','space_post','contents_post','works_post'),
  				'posts_per_page' => 5,
          'meta_key' => 'top_visual',
          'meta_value' => 1
  			);
      ...
      <div>
        <?php
          if( $post->post_type == "works_post" ) {
            $mv_link = home_url()."/works/";
          } else {
            $mv_link = get_the_permalink();
          }
        ?>
  			<a href="<?php echo $mv_link; ?>">
